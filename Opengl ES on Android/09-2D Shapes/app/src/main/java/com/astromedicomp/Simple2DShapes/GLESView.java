package com.astromedicomp.Simple2DShapes;
    ...
    private void initialize(GL10 gl)
    {
        ...
        if(iShaderCompileStatus[0] == GLES32.GL_FALSE)
        {
            ...
            if(iInfoLog[0] > 0)
            {
                ...
                System.out.println("OGL : Fragment Shader Compilation Log :"+szInfoLog);
                uninititalize();
                System.exit(0);
            }
        }
        ...
        ByteBuffer byteBuffertriangle = ByteBuffer.allocateDirect(triangle_vertices.length*4);
        byteBuffertriangle.order(ByteOrder.nativeOrder());
        FloatBuffer verticesBufferTriangle = byteBuffertriangle.asFloatBuffer();
        verticesBufferTriangle.put(triangle_vertices);
        verticesBufferTriangle.position(0);

        ByteBuffer byteBufferSquare = ByteBuffer.allocateDirect(square_vertices.length*4);
