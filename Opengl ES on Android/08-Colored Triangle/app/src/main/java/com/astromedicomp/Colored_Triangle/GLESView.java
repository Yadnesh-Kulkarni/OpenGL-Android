package com.astromedicomp.Colored_Triangle;
...
public class GLESView extends GLSurfaceView implements GLSurfaceView.Renderer,OnGestureListener,OnDoubleTapListener 
{
    ...
    private void initialize(GL10 gl)
    {
        ...
        ByteBuffer byteBufferVertex = ByteBuffer.allocateDirect(triangle_vertices.length*4);
        byteBufferVertex.order(ByteOrder.nativeOrder());
        FloatBuffer verticesBuffer = byteBufferVertex.asFloatBuffer();
        verticesBuffer.put(triangle_vertices);
        ...
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER,triangle_vertices.length*4,verticesBuffer,GLES32.GL_STATIC_DRAW);
